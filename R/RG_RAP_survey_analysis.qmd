...
This Quarto document analyses the 2023 (early 2024) RAP Survey results for the Regions Group division.
...
For managers it stems from not rally understanding how RAP is implemented, 
thus not being able to provided the resources (including time) to the analysts.
